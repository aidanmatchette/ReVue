            ...
            <div className='header-container hp-container'>
                <div className='header-flex'>
                    ...
                    <div className='header-content'>
                        ...
                        <div className='header-content'>
                            <img className='image' src="https://content.usaa.com/mcontent/static_assets/Media/military-child-reunited-with-father-768.jpg" width="600" height="500"/>
                        </div>
                    </div>
                </div>
            </div>
